module.exports = {
  ...
  createMenu: (menu_id, name, price, quantity, type, created_at, created_by, img_url) => {
  	const query = {
	  // give the query a unique name
	  name: 'create-menu',
	  text: 'INSERT INTO public.menus(menu_id, name, price, quantity, type, created_at, created_by, img_url) VALUES ($1, $2, $3, $4, $5, $6, $7, $8)',
	  values: [menu_id, name, price, quantity, type, created_at, created_by, img_url]
	};
    return query;
  },
};